        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <form v-on:submit.prevent="addNewTask">
                    ...
                    <input type="text" v-model="taskname" id="tasknameinput"
                    ...
                    <button v-if="this.isEdit==false" type="submit"
                     ...
                     <button v-else type= "button" v-on:click.prevent="updateTask()"
                ...
                <table class="table">
                    <tr v-for="(todo) in todos" v-bind:key="todo.id" v-bind:title="todo.title">
                        ...
                        <td class="text-right">
                            ...
                            <button v-on:click="deleteTask(todo.title, todo._id)" class="btn btn-danger">Delete</button>
                        </td>
